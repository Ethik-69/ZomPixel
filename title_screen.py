...
class TitleScreen(object):
    ...
    def help_screen_text(self):
        ...
        self.text_blit(self.final_score_font,
                       ...
                       (100, 20, 20), (self.background.get_width()/2, 80))

        self.text_blit(self.final_score_font,
                       "Le niveau zero vous servira d'entrainement ;)",
                       (100, 20, 20), (self.background.get_width()/2, 110))
        ...
        self.text_blit(self.final_score_font,
                       ...
                       (100, 20, 20), (self.background.get_width()/2, 230))

        self.text_blit(self.final_score_font,
                       "A chaque fois que vous en tuerez un, un autre apparaitras",
                       (100, 20, 20), (self.background.get_width()/2, 260))

        self.text_blit(self.final_score_font,
                       "Toute les vingt secondes, le nomrbe de citoyen augmentera",
                       (100, 20, 20), (self.background.get_width()/2, 290))
        ...
        self.text_blit(self.final_score_font,
                       ...
                       (100, 20, 20), (self.background.get_width()/2, 430))

        self.text_blit(self.final_score_font,
                       "Si l'un de vos zompies mange un citoyen: +1 point.",
                       (100, 20, 20), (self.background.get_width()/2, 460))

        self.text_blit(self.final_score_font,
                       "Cliquez pour deplacer le zompie principal.",
                       (100, 20, 20), (self.background.get_width()/2, 490))

        self.text_blit(self.final_score_font,
                       "Ou restez appuyer, il suivra votre souris.",
                       (100, 20, 20), (self.background.get_width()/2, 520))

        self.text_blit(self.final_score_font,
                       "Les bouches d'egouts sont des pieges mortels.",
                       (100, 20, 20), (self.background.get_width()/2, 550))
