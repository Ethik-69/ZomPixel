...
class TitleScreen(object):
    ...
    def help_screen_text(self):
        ...
        self.text_blit(
            ...
            (100, 20, 20),
            (self.background.get_width() / 2, 150),
        )
        ...
        self.text_blit(
            ...
            (100, 20, 20),
            (self.background.get_width() / 2, 250),
        )
        ...
        self.text_blit(
            ...
            (100, 20, 20),
            (self.background.get_width() / 2, 300),
        )
        ...
        self.text_blit(
            ...
            (100, 20, 20),
            (self.background.get_width() / 2, 350),
        )
        ...
        self.text_blit(
            ...
            (100, 20, 20),
            (self.background.get_width() / 2, 450),
        )
        ...
        self.text_blit(
            ...
            "Facebook: ZompiGame",
            (100, 20, 20),
            (self.background.get_width() / 2, 650),
        )
    ...
    def get_frames(self, character, name):
        character["walkingFramesLeft"] = self.sprite_sheet.get_character_frames(
            character["walkingFramesLeft"], constants.MOVING_SPRITE_X, 0, 75, 125
        )

        character["walkingFramesRight"] = self.sprite_sheet.get_character_frames(
            character["walkingFramesRight"], constants.MOVING_SPRITE_X, 0, 75, 125, True
        )

        character["walkingFramesUp"] = self.sprite_sheet.get_character_frames(
            character["walkingFramesUp"], constants.MOVING_SPRITE_X, 125, 75, 125
        )

        character["walkingFramesDown"] = self.sprite_sheet.get_character_frames(
            character["walkingFramesDown"], constants.MOVING_SPRITE_X, 250, 75, 125
        )

        character["stopFrame"] = self.sprite_sheet.get_image(
